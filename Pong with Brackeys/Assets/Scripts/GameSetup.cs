...
public class GameSetup : MonoBehaviour
{
    ...
    public BoxCollider2D topWall = null;
    public BoxCollider2D bottomWall = null;
    public BoxCollider2D leftWall = null;
    public BoxCollider2D rightWall = null;
    ...
    private void Start()
    {
        ...
        //0.5f is half of width of collider
        ...
        player1.position.Set(mainCamera.ScreenToWorldPoint(new Vector3(75f, 0f, 0f)).x, 0f, 0f);
        player2.position.Set(mainCamera.ScreenToWorldPoint(new Vector3(Screen.width - 75f, 0f, 0f)).x, 0f, 0f);
